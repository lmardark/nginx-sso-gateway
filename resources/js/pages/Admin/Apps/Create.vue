        ...
        <main class="flex flex-1 justify-center p-6">
            <div class="w-full max-w-2xl">
                ...
                <div class="mb-6">
                    ...
                    <h1 class="text-2xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">Nova aplicação</h1>
                    <p class="mt-1 text-sm text-[#706f6c] dark:text-[#A1A09A]">
                        Registre uma nova aplicação para usar o SSO. A API Key será gerada automaticamente.
                    </p>
                </div>
                        ...
                        <div class="px-8 py-6">
                            ...
                            <div class="flex flex-col gap-5">
                                ...
                                <div class="flex flex-col gap-1.5">
                                    ...
                                    />
                                    <p class="text-xs text-[#706f6c] dark:text-[#A1A09A]">
                                        URL padrão para redirecionar após a autenticação SSO.
                                    </p>
